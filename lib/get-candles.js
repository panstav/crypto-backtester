...
export default async function getCandleData(coinSymbol, interval) {
	...
	const { endpointUrl, ticksPerResultsFragment, stepSize, isUpdatingHistory, baseCurrency } = getDefaults();
